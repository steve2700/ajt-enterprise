...
const AREA_NAME = 'Mokopane'
const AREA_SLUG = 'mokopane'
...
// Mokopane-specific suburbs for local relevance
const SUBURBS = [
  'Mahwelereng', 'Sandriver', 'Perskebult', 'Rebone', 'Ext 1',
  'Ext 4', 'Nirvana Park', 'Uitkyk',
]

export const metadata: Metadata = {
  title: 'Shadeport & Carport Installation Mokopane | AJT Enterprise',
  description:
    "Mokopane's trusted shadeport and carport specialists. New installations, repairs and maintenance for homes and businesses across Mokopane and surrounding suburbs. Free written quote, call 065 867 7363.",
  keywords: [
    'shadeport installation Mokopane',
    'carports Mokopane',
    'shadeport repairs Mokopane',
    'carport installation Mokopane',
    'cantilever shadeports Mokopane',
    'shadeport prices Mokopane',
    'parking bay shadeports Mokopane',
    'shadeport maintenance Mokopane',
    'shadeports Mahwelereng',
    'shadeports Sandriver',
  ],
  ...
  openGraph: {
    ...
    title: 'Shadeport & Carport Installation Mokopane | AJT Enterprise',
    description:
      "Mokopane's trusted shadeport and carport specialists. New installations, repairs and maintenance. Free written quote, call 065 867 7363.",
    images: [{ url: '/images/shadeport-maintenance.png', width: 1200, height: 900, alt: 'Shadeport installation in Mokopane by AJT Enterprise', type: 'image/png' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Shadeport & Carport Installation Mokopane | AJT Enterprise',
    description: "Mokopane's trusted shadeport and carport specialists. Call 065 867 7363.",
    images: ['/images/shadeport-maintenance.png'],
  },
  robots: {
...
const faqs = [
  ...
  {
    question: 'What areas near Mokopane do you also cover?',
    answer: 'Alongside Mokopane, we install and maintain shadeports and carports across Polokwane, Tzaneen, Thohoyandou, Lephalale and Bela-Bela in Limpopo, and across Gauteng including Johannesburg, Pretoria and Sandton.',
  },
]
...
export default function MokopaneAreaPage() {
  return (
    <>
      ...
      <section className="relative overflow-hidden" style={{ background: BG }} aria-label={`Shadeport and carport installation in ${AREA_NAME}`}>
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/shadeport-maintenance.png"

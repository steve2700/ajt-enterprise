...
const AREA_NAME = 'Sandton'
const AREA_SLUG = 'sandton'
...
// Sandton-specific suburbs for local relevance
const SUBURBS = [
  'Morningside', 'Rivonia', 'Paulshof', 'Atholl', 'Illovo',
  'Hyde Park', 'Sandhurst', 'Benmore',
]

export const metadata: Metadata = {
  title: 'Shadeport & Carport Installation Sandton | AJT Enterprise',
  description:
    "Sandton's trusted shadeport and carport specialists. New installations, repairs and maintenance for homes and businesses across Sandton and surrounding suburbs. Free written quote, call 065 867 7363.",
  keywords: [
    'shadeport installation Sandton',
    'carports Sandton',
    'shadeport repairs Sandton',
    'carport installation Sandton',
    'cantilever shadeports Sandton',
    'shadeport prices Sandton',
    'parking bay shadeports Sandton',
    'shadeport maintenance Sandton',
    'shadeports Morningside',
    'shadeports Rivonia',
  ],
  ...
  openGraph: {
    ...
    title: 'Shadeport & Carport Installation Sandton | AJT Enterprise',
    description:
      "Sandton's trusted shadeport and carport specialists. New installations, repairs and maintenance. Free written quote, call 065 867 7363.",
    images: [{ url: '/images/carports.png', width: 1200, height: 900, alt: 'Shadeport installation in Sandton by AJT Enterprise', type: 'image/png' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Shadeport & Carport Installation Sandton | AJT Enterprise',
    description: "Sandton's trusted shadeport and carport specialists. Call 065 867 7363.",
...
const faqs = [
  ...
  {
    question: 'What areas near Sandton do you also cover?',
    answer: 'Alongside Sandton, we install and maintain shadeports and carports across Johannesburg, Pretoria, Centurion, Midrand, Randburg, Roodepoort and Vereeniging in Gauteng, and across Limpopo.',
  },
]

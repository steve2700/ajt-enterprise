...
const AREA_NAME = 'Midrand'
const AREA_SLUG = 'midrand'
...
// Midrand-specific suburbs for local relevance
const SUBURBS = [
  'Noordwyk', 'Kyalami', 'Halfway House', 'Vorna Valley', 'Carlswald',
  'Blue Hills', 'Beaulieu', 'Erand Gardens',
]

export const metadata: Metadata = {
  title: 'Shadeport & Carport Installation Midrand | AJT Enterprise',
  description:
    "Midrand's trusted shadeport and carport specialists. New installations, repairs and maintenance for homes and businesses across Midrand and surrounding suburbs. Free written quote, call 065 867 7363.",
  keywords: [
    'shadeport installation Midrand',
    'carports Midrand',
    'shadeport repairs Midrand',
    'carport installation Midrand',
    'cantilever shadeports Midrand',
    'shadeport prices Midrand',
    'parking bay shadeports Midrand',
    'shadeport maintenance Midrand',
    'shadeports Noordwyk',
    'shadeports Kyalami',
  ],
  ...
  openGraph: {
    ...
    title: 'Shadeport & Carport Installation Midrand | AJT Enterprise',
    description:
      "Midrand's trusted shadeport and carport specialists. New installations, repairs and maintenance. Free written quote, call 065 867 7363.",
    images: [{ url: '/images/carport-installation.png', width: 1200, height: 900, alt: 'Shadeport installation in Midrand by AJT Enterprise', type: 'image/png' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Shadeport & Carport Installation Midrand | AJT Enterprise',
    description: "Midrand's trusted shadeport and carport specialists. Call 065 867 7363.",
...
const faqs = [
  ...
  {
    question: 'What areas near Midrand do you also cover?',
    answer: 'Alongside Midrand, we install and maintain shadeports and carports across Johannesburg, Pretoria, Sandton, Centurion, Randburg, Roodepoort and Vereeniging in Gauteng, and across Limpopo.',
  },
]

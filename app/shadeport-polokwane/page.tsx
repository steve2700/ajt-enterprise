...
const AREA_NAME = 'Polokwane'
const AREA_SLUG = 'polokwane'
...
// Polokwane-specific suburbs for local relevance
const SUBURBS = [
  'Bendor', 'Fauna Park', 'Ivy Park', 'Flora Park', 'Nirvana',
  'Welgelegen', 'Sterpark', 'Penina Park',
]

export const metadata: Metadata = {
  title: 'Shadeport & Carport Installation Polokwane | AJT Enterprise',
  description:
    "Polokwane's trusted shadeport and carport specialists. New installations, repairs and maintenance for homes and businesses across Polokwane and surrounding suburbs. Free written quote, call 065 867 7363.",
  keywords: [
    'shadeport installation Polokwane',
    'carports Polokwane',
    'shadeport repairs Polokwane',
    'carport installation Polokwane',
    'cantilever shadeports Polokwane',
    'shadeport prices Polokwane',
    'parking bay shadeports Polokwane',
    'shadeport maintenance Polokwane',
    'shadeports Bendor',
    'shadeports Fauna Park',
  ],
  ...
  openGraph: {
    ...
    title: 'Shadeport & Carport Installation Polokwane | AJT Enterprise',
    description:
      "Polokwane's trusted shadeport and carport specialists. New installations, repairs and maintenance. Free written quote, call 065 867 7363.",
    images: [{ url: '/images/hero-shadeport.png', width: 1200, height: 900, alt: 'Shadeport installation in Polokwane by AJT Enterprise', type: 'image/png' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Shadeport & Carport Installation Polokwane | AJT Enterprise',
    description: "Polokwane's trusted shadeport and carport specialists. Call 065 867 7363.",
    images: ['/images/hero-shadeport.png'],
  },
  robots: {
...
const faqs = [
  ...
  {
    question: 'What areas near Polokwane do you also cover?',
    answer: 'Alongside Polokwane, we install and maintain shadeports and carports across Tzaneen, Mokopane, Thohoyandou, Lephalale and Bela-Bela in Limpopo, and across Gauteng including Johannesburg, Pretoria and Sandton.',
  },
]
...
export default function PolokwaneAreaPage() {
  return (
    <>

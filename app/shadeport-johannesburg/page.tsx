...
const AREA_NAME = 'Johannesburg'
const AREA_SLUG = 'johannesburg'
...
// Johannesburg-specific suburbs for local relevance (Sandton, Randburg and
// Roodepoort get their own dedicated area pages, so they're not repeated here)
const SUBURBS = [
  'Bryanston', 'Fourways', 'Rosebank', 'Melville', 'Northcliff',
  'Kensington', 'Bedfordview', 'Linden', 'Parkhurst', 'Greenside',
]

export const metadata: Metadata = {
  title: 'Shadeport & Carport Installation Johannesburg | AJT Enterprise',
  description:
    "Johannesburg's trusted shadeport and carport specialists. New installations, repairs and maintenance for homes and businesses across Johannesburg and surrounding suburbs. Free written quote, call 065 867 7363.",
  keywords: [
    'shadeport installation Johannesburg',
    'carports Johannesburg',
    'shadeport repairs Johannesburg',
    'carport installation Johannesburg',
    'cantilever shadeports Johannesburg',
    'shadeport prices Johannesburg',
    'parking bay shadeports Johannesburg',
    'shadeport maintenance Johannesburg',
    'shadeports Bryanston',
    'shadeports Fourways',
  ],
  ...
  openGraph: {
    ...
    title: 'Shadeport & Carport Installation Johannesburg | AJT Enterprise',
    description:
      "Johannesburg's trusted shadeport and carport specialists. New installations, repairs and maintenance. Free written quote, call 065 867 7363.",
    images: [{ url: '/images/shadeport-installation.png', width: 1200, height: 900, alt: 'Shadeport installation in Johannesburg by AJT Enterprise', type: 'image/png' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Shadeport & Carport Installation Johannesburg | AJT Enterprise',
    description: "Johannesburg's trusted shadeport and carport specialists. Call 065 867 7363.",
...
const faqs = [
  ...
  {
    question: 'What areas near Johannesburg do you also cover?',
    answer: 'Alongside Johannesburg, we install and maintain shadeports and carports across Pretoria, Sandton, Centurion, Midrand, Randburg, Roodepoort and Vereeniging in Gauteng, and across Limpopo.',
  },
]

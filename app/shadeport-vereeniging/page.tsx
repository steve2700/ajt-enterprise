...
const AREA_NAME = 'Vereeniging'
const AREA_SLUG = 'vereeniging'
...
// Vereeniging-specific suburbs for local relevance
const SUBURBS = [
  'Three Rivers', 'Duncanville', 'Peacehaven', 'Arcon Park', 'Bedworth Park',
  'Roshnee', 'Sonlandpark', 'Unitas Park',
]

export const metadata: Metadata = {
  title: 'Shadeport & Carport Installation Vereeniging | AJT Enterprise',
  description:
    "Vereeniging's trusted shadeport and carport specialists. New installations, repairs and maintenance for homes and businesses across Vereeniging and surrounding suburbs. Free written quote, call 065 867 7363.",
  keywords: [
    'shadeport installation Vereeniging',
    'carports Vereeniging',
    'shadeport repairs Vereeniging',
    'carport installation Vereeniging',
    'cantilever shadeports Vereeniging',
    'shadeport prices Vereeniging',
    'parking bay shadeports Vereeniging',
    'shadeport maintenance Vereeniging',
    'shadeports Three Rivers',
    'shadeports Duncanville',
  ],
  ...
  openGraph: {
    ...
    title: 'Shadeport & Carport Installation Vereeniging | AJT Enterprise',
    description:
      "Vereeniging's trusted shadeport and carport specialists. New installations, repairs and maintenance. Free written quote, call 065 867 7363.",
    images: [{ url: '/images/car_shadeports.jfif', width: 1200, height: 900, alt: 'Shadeport installation in Vereeniging by AJT Enterprise', type: 'image/png' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Shadeport & Carport Installation Vereeniging | AJT Enterprise',
    description: "Vereeniging's trusted shadeport and carport specialists. Call 065 867 7363.",
    images: ['/images/car_shadeports.jfif'],
  },
  robots: {
...
const faqs = [
  ...
  {
    question: 'What areas near Vereeniging do you also cover?',
    answer: 'Alongside Vereeniging, we install and maintain shadeports and carports across Johannesburg, Pretoria, Sandton, Centurion, Midrand, Randburg and Roodepoort in Gauteng, and across Limpopo.',
  },
]
...
export default function VereenigingAreaPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(serviceSchema) }} />
      <AreaSchema areaName={AREA_NAME} url={AREA_URL} suburbs={SUBURBS} region="Gauteng" />
      <FAQSchema faqs={faqs} />

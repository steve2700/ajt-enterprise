...
const AREA_NAME = 'Randburg'
const AREA_SLUG = 'randburg'
...
// Randburg-specific suburbs for local relevance
const SUBURBS = [
  'Ferndale', 'Cresta', 'Blairgowrie', 'Fontainebleau', 'Northriding',
  'Olivedale', 'Bromhof', 'Windsor',
]

export const metadata: Metadata = {
  title: 'Shadeport & Carport Installation Randburg | AJT Enterprise',
  description:
    "Randburg's trusted shadeport and carport specialists. New installations, repairs and maintenance for homes and businesses across Randburg and surrounding suburbs. Free written quote, call 065 867 7363.",
  keywords: [
    'shadeport installation Randburg',
    'carports Randburg',
    'shadeport repairs Randburg',
    'carport installation Randburg',
    'cantilever shadeports Randburg',
    'shadeport prices Randburg',
    'parking bay shadeports Randburg',
    'shadeport maintenance Randburg',
    'shadeports Ferndale',
    'shadeports Cresta',
  ],
  ...
  openGraph: {
    ...
    title: 'Shadeport & Carport Installation Randburg | AJT Enterprise',
    description:
      "Randburg's trusted shadeport and carport specialists. New installations, repairs and maintenance. Free written quote, call 065 867 7363.",
    images: [{ url: '/images/cantilever-shade-port.jpg', width: 1200, height: 900, alt: 'Shadeport installation in Randburg by AJT Enterprise', type: 'image/png' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Shadeport & Carport Installation Randburg | AJT Enterprise',
    description: "Randburg's trusted shadeport and carport specialists. Call 065 867 7363.",
    images: ['/images/cantilever-shade-port.jpg'],
  },
  robots: {
...
const faqs = [
  ...
  {
    question: 'What areas near Randburg do you also cover?',
    answer: 'Alongside Randburg, we install and maintain shadeports and carports across Johannesburg, Pretoria, Sandton, Centurion, Midrand, Roodepoort and Vereeniging in Gauteng, and across Limpopo.',
  },
]

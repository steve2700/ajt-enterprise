...
const AREA_NAME = 'Centurion'
const AREA_SLUG = 'centurion'
...
// Centurion-specific suburbs for local relevance
const SUBURBS = [
  'Wierda Park', 'Zwartkop', 'Rooihuiskraal', 'Highveld', 'Eldoraigne',
  'The Reeds', 'Doringkloof', 'Southdowns',
]

export const metadata: Metadata = {
  title: 'Shadeport & Carport Installation Centurion | AJT Enterprise',
  description:
    "Centurion's trusted shadeport and carport specialists. New installations, repairs and maintenance for homes and businesses across Centurion and surrounding suburbs. Free written quote, call 065 867 7363.",
  keywords: [
    'shadeport installation Centurion',
    'carports Centurion',
    'shadeport repairs Centurion',
    'carport installation Centurion',
    'cantilever shadeports Centurion',
    'shadeport prices Centurion',
    'parking bay shadeports Centurion',
    'shadeport maintenance Centurion',
    'shadeports Wierda Park',
    'shadeports Zwartkop',
  ],
  ...
  openGraph: {
    ...
    title: 'Shadeport & Carport Installation Centurion | AJT Enterprise',
    description:
      "Centurion's trusted shadeport and carport specialists. New installations, repairs and maintenance. Free written quote, call 065 867 7363.",
    images: [{ url: '/images/parking-bay-shadeports.png', width: 1200, height: 900, alt: 'Shadeport installation in Centurion by AJT Enterprise', type: 'image/png' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Shadeport & Carport Installation Centurion | AJT Enterprise',
    description: "Centurion's trusted shadeport and carport specialists. Call 065 867 7363.",
...
const faqs = [
  ...
  {
    question: 'What areas near Centurion do you also cover?',
    answer: 'Alongside Centurion, we install and maintain shadeports and carports across Johannesburg, Pretoria, Sandton, Midrand, Randburg, Roodepoort and Vereeniging in Gauteng, and across Limpopo.',
  },
]

...
const AREA_NAME = 'Pretoria'
const AREA_SLUG = 'pretoria'
...
// Pretoria-specific suburbs for local relevance
const SUBURBS = [
  'Menlyn', 'Waterkloof', 'Brooklyn', 'Hatfield', 'Faerie Glen',
  'Montana', 'Garsfontein', 'Moreleta Park',
]

export const metadata: Metadata = {
  title: 'Shadeport & Carport Installation Pretoria | AJT Enterprise',
  description:
    "Pretoria's trusted shadeport and carport specialists. New installations, repairs and maintenance for homes and businesses across Pretoria and surrounding suburbs. Free written quote, call 065 867 7363.",
  keywords: [
    'shadeport installation Pretoria',
    'carports Pretoria',
    'shadeport repairs Pretoria',
    'carport installation Pretoria',
    'cantilever shadeports Pretoria',
    'shadeport prices Pretoria',
    'parking bay shadeports Pretoria',
    'shadeport maintenance Pretoria',
    'shadeports Menlyn',
    'shadeports Waterkloof',
  ],
  ...
  openGraph: {
    ...
    title: 'Shadeport & Carport Installation Pretoria | AJT Enterprise',
    description:
      "Pretoria's trusted shadeport and carport specialists. New installations, repairs and maintenance. Free written quote, call 065 867 7363.",
    images: [{ url: '/images/cantilever-shadeports.png', width: 1200, height: 900, alt: 'Shadeport installation in Pretoria by AJT Enterprise', type: 'image/png' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Shadeport & Carport Installation Pretoria | AJT Enterprise',
    description: "Pretoria's trusted shadeport and carport specialists. Call 065 867 7363.",
...
const faqs = [
  ...
  {
    question: 'What areas near Pretoria do you also cover?',
    answer: 'Alongside Pretoria, we install and maintain shadeports and carports across Johannesburg, Sandton, Centurion, Midrand, Randburg, Roodepoort and Vereeniging in Gauteng, and across Limpopo.',
  },
]

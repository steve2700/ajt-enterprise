...
const AREA_NAME = 'Tzaneen'
const AREA_SLUG = 'tzaneen'
...
// Tzaneen-specific suburbs for local relevance
const SUBURBS = [
  'Aqua Park', 'Fairview', 'Westfalia Park', 'Bergview', 'Tarentaal',
  'Rita Park', 'Nkowankowa', 'Letaba',
]

export const metadata: Metadata = {
  title: 'Shadeport & Carport Installation Tzaneen | AJT Enterprise',
  description:
    "Tzaneen's trusted shadeport and carport specialists. New installations, repairs and maintenance for homes and businesses across Tzaneen and surrounding suburbs. Free written quote, call 065 867 7363.",
  keywords: [
    'shadeport installation Tzaneen',
    'carports Tzaneen',
    'shadeport repairs Tzaneen',
    'carport installation Tzaneen',
    'cantilever shadeports Tzaneen',
    'shadeport prices Tzaneen',
    'parking bay shadeports Tzaneen',
    'shadeport maintenance Tzaneen',
    'shadeports Aqua Park',
    'shadeports Fairview',
  ],
  ...
  openGraph: {
    ...
    title: 'Shadeport & Carport Installation Tzaneen | AJT Enterprise',
    description:
      "Tzaneen's trusted shadeport and carport specialists. New installations, repairs and maintenance. Free written quote, call 065 867 7363.",
    images: [{ url: '/images/shadeport-repairs.png', width: 1200, height: 900, alt: 'Shadeport installation in Tzaneen by AJT Enterprise', type: 'image/png' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Shadeport & Carport Installation Tzaneen | AJT Enterprise',
    description: "Tzaneen's trusted shadeport and carport specialists. Call 065 867 7363.",
...
const faqs = [
  ...
  {
    question: 'What areas near Tzaneen do you also cover?',
    answer: 'Alongside Tzaneen, we install and maintain shadeports and carports across Polokwane, Mokopane, Thohoyandou, Lephalale and Bela-Bela in Limpopo, and across Gauteng including Johannesburg, Pretoria and Sandton.',
  },
]
...
export default function TzaneenAreaPage() {
  return (
    <>

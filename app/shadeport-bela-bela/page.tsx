...
const AREA_NAME = 'Bela-Bela'
const AREA_SLUG = 'bela-bela'
...
// Bela-Bela-specific suburbs for local relevance
const SUBURBS = [
  'Leseding', 'Masodi', 'Radium', 'Rooiberg', 'Pienaarsrivier',
  'Kranskop', 'Zwartkloof', 'Ben Alberts',
]

export const metadata: Metadata = {
  title: 'Shadeport & Carport Installation Bela-Bela | AJT Enterprise',
  description:
    "Bela-Bela's trusted shadeport and carport specialists. New installations, repairs and maintenance for homes and businesses across Bela-Bela and surrounding suburbs. Free written quote, call 065 867 7363.",
  keywords: [
    'shadeport installation Bela-Bela',
    'carports Bela-Bela',
    'shadeport repairs Bela-Bela',
    'carport installation Bela-Bela',
    'cantilever shadeports Bela-Bela',
    'shadeport prices Bela-Bela',
    'parking bay shadeports Bela-Bela',
    'shadeport maintenance Bela-Bela',
    'shadeports Leseding',
    'shadeports Masodi',
  ],
  ...
  openGraph: {
    ...
    title: 'Shadeport & Carport Installation Bela-Bela | AJT Enterprise',
    description:
      "Bela-Bela's trusted shadeport and carport specialists. New installations, repairs and maintenance. Free written quote, call 065 867 7363.",
    images: [{ url: '/images/why-choose-us.png', width: 1200, height: 900, alt: 'Shadeport installation in Bela-Bela by AJT Enterprise', type: 'image/png' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Shadeport & Carport Installation Bela-Bela | AJT Enterprise',
    description: "Bela-Bela's trusted shadeport and carport specialists. Call 065 867 7363.",
    images: ['/images/why-choose-us.png'],
  },
  robots: {
...
const faqs = [
  ...
  {
    question: 'What areas near Bela-Bela do you also cover?',
    answer: 'Alongside Bela-Bela, we install and maintain shadeports and carports across Polokwane, Tzaneen, Mokopane, Thohoyandou and Lephalale in Limpopo, and across Gauteng including Johannesburg, Pretoria and Sandton.',
  },
]
...
export default function BelaBelaAreaPage() {
  return (
    <>

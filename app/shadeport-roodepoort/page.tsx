...
const AREA_NAME = 'Roodepoort'
const AREA_SLUG = 'roodepoort'
...
// Roodepoort-specific suburbs for local relevance
const SUBURBS = [
  'Wilgeheuwel', 'Constantia Kloof', 'Horizon', 'Ruimsig', 'Little Falls',
  'Weltevreden Park', "Allen's Nek", 'Florida',
]

export const metadata: Metadata = {
  title: 'Shadeport & Carport Installation Roodepoort | AJT Enterprise',
  description:
    "Roodepoort's trusted shadeport and carport specialists. New installations, repairs and maintenance for homes and businesses across Roodepoort and surrounding suburbs. Free written quote, call 065 867 7363.",
  keywords: [
    'shadeport installation Roodepoort',
    'carports Roodepoort',
    'shadeport repairs Roodepoort',
    'carport installation Roodepoort',
    'cantilever shadeports Roodepoort',
    'shadeport prices Roodepoort',
    'parking bay shadeports Roodepoort',
    'shadeport maintenance Roodepoort',
    'shadeports Wilgeheuwel',
    'shadeports Constantia Kloof',
  ],
  ...
  openGraph: {
    ...
    title: 'Shadeport & Carport Installation Roodepoort | AJT Enterprise',
    description:
      "Roodepoort's trusted shadeport and carport specialists. New installations, repairs and maintenance. Free written quote, call 065 867 7363.",
    images: [{ url: '/images/custom_shadeports.jfif', width: 1200, height: 900, alt: 'Shadeport installation in Roodepoort by AJT Enterprise', type: 'image/png' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Shadeport & Carport Installation Roodepoort | AJT Enterprise',
    description: "Roodepoort's trusted shadeport and carport specialists. Call 065 867 7363.",
    images: ['/images/custom_shadeports.jfif'],
  },
  robots: {
...
const faqs = [
  ...
  {
    question: 'What areas near Roodepoort do you also cover?',
    answer: 'Alongside Roodepoort, we install and maintain shadeports and carports across Johannesburg, Pretoria, Sandton, Centurion, Midrand, Randburg and Vereeniging in Gauteng, and across Limpopo.',
  },
]

...
const PAGE_URL = `${BASE_URL}/cantilever-shadeports`
const PHONE_DISPLAY = '065 867 7363'
const PHONE_TEL = '0658677363'

export const metadata: Metadata = {
  title: 'Cantilever Shadeports Gauteng & Limpopo | AJT Enterprise',
  description:
    'Cantilever shadeport installation across Gauteng & Limpopo. No centre poles, clean sightlines, engineered for durability. Free written quote, call 065 867 7363.',
  keywords: [
    'cantilever shadeports Gauteng',
    'cantilever shadeports Limpopo',
    'cantilever carport installation',
    'no pole shadeport',
    'cantilever shadeport price',
    'cantilever shadeport Johannesburg',
    'cantilever shadeport Pretoria',
    'cantilever shadeport Polokwane',
  ],
  ...
  openGraph: {
    ...
    title: 'Cantilever Shadeports Gauteng & Limpopo | AJT Enterprise',
    description: 'No centre poles, clean sightlines. Cantilever shadeport installation across Gauteng & Limpopo. Call 065 867 7363.',
    images: [{ url: '/images/cantilever-shadeports.png', width: 1200, height: 900, alt: 'Cantilever shadeport by AJT Enterprise', type: 'image/png' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Cantilever Shadeports Gauteng & Limpopo | AJT Enterprise',
    description: 'No centre poles, clean sightlines. Cantilever shadeport installation across Gauteng & Limpopo.',
    images: ['/images/cantilever-shadeports.png'],
  },
  robots: {
...
const faqs = [
  {
    question: "What's the difference between a cantilever and a post-supported shadeport?",
    answer:
      'A post-supported shadeport uses upright poles along the edges. A cantilever shadeport is anchored on one side only, using a reinforced foundation and frame, leaving the parking area completely clear of poles. It costs more but gives cleaner sightlines and easier vehicle access.',
  },
  {
    question: 'Why choose a cantilever shadeport over a standard one?',
    answer:
      'Cantilever structures suit tight driveways, showrooms and spaces where poles would get in the way of parking, opening doors or turning a vehicle. They also give a cleaner, more architectural look for homes and businesses that want a premium finish.',
  },
  {
    question: 'Does a cantilever shadeport need a special foundation?',
    answer:
      'Yes. Because the whole structure is supported from one side, the foundation on that side needs to be engineered and reinforced to carry the load safely. We assess your site and design the foundation as part of the quote.',
  },
  {
    question: 'Can a cantilever shadeport cover more than one parking bay?',
    answer:
      'Yes, cantilever structures can span multiple bays, which is common for commercial parking, dealership forecourts and larger driveways. Span and cost scale with size, and we will confirm exact figures after a site visit.',
  },
  {
    question: 'Which areas do you install cantilever shadeports in?',
    answer:
      'We install cantilever shadeports across Gauteng, including Johannesburg, Pretoria, Sandton, Centurion, Midrand, Randburg, Roodepoort and Vereeniging, and across Limpopo, including Polokwane, Tzaneen, Mokopane, Thohoyandou, Lephalale and Bela-Bela.',
  },
]

const benefits = [
  { title: 'No Centre Poles', body: 'A completely open parking area, with the structure anchored on one side only, no poles in the way.' },
  { title: 'Engineered Cantilever Frame', body: 'A reinforced foundation and frame designed to carry the full load safely, assessed for your specific site.' },
  { title: 'Ideal For Tight Spaces', body: 'Suited to narrow driveways, showrooms and areas where post-supported structures would restrict access.' },
  { title: 'Premium, Architectural Finish', body: 'A cleaner look that suits modern homes, dealerships and commercial entrances.' },
]

const process = [
  { step: '01', title: 'Free Site Visit & Quote', body: 'We assess your site, load requirements and foundation needs, then give you a clear written quote.' },
  { step: '02', title: 'Engineering & Design', body: 'We design the cantilever frame and foundation to suit the span, load and look you want.' },
  { step: '03', title: 'Manufacture', body: 'Your cantilever shadeport is fabricated to spec using weather-rated materials built for local conditions.' },
  { step: '04', title: 'Professional Installation', body: 'Our certified team pours the foundation, installs and anchors the structure, then walks you through the result.' },
]

const structureTypes = [
  { label: 'Driveways & Showrooms', desc: 'Clear, unobstructed parking and display space' },
  { label: 'Dealership Forecourts', desc: 'Multi-bay cantilever cover for vehicle displays' },
  { label: 'Architectural Homes', desc: 'A premium, minimalist look for modern properties' },
  { label: 'Commercial Entrances', desc: 'Clean sightlines for offices & retail frontages' },
]
...
const serviceSchema = {
  ...
  '@type': 'Service',
  '@id': `${PAGE_URL}#service`,
  name: 'Cantilever Shadeports',
  serviceType: 'Cantilever Shadeport Installation',
  description: 'Cantilever shadeport installation with no centre poles, engineered for residential and commercial properties across Gauteng and Limpopo.',
  url: PAGE_URL,
  provider: {
    '@type': 'LocalBusiness',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Cantilever Shadeports' },
  ],
}
...
export default function CantileverShadeportsPage() {
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <nav aria-label="Breadcrumb" className="py-3 text-sm">
            <ol className="flex flex-wrap items-center gap-1.5">
              ...
              <li className="text-[#1a1a1a]/30" aria-hidden="true">/</li>
              <li className="text-[#1a1a1a] font-medium" aria-current="page">Cantilever Shadeports</li>
            </ol>
          </nav>
        </div>
      </div>
      ...
      {/* HERO */}
      <section className="relative overflow-hidden" style={{ background: BG }} aria-label="Cantilever shadeports across Gauteng and Limpopo">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/cantilever-shadeports.png"
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-16 md:py-24">
          <div className="max-w-2xl">
            <p className="text-xs font-bold tracking-[0.35em] uppercase mb-5" style={{ color: GOLD }}>
              Cantilever Shadeports · Gauteng &amp; Limpopo
            </p>
            ...
            <p className="text-white/65 text-base md:text-lg leading-relaxed mb-8 max-w-xl">
              Cantilever shadeports are anchored on one side only, leaving your driveway,
              showroom or parking area completely open. Engineered for Gauteng and
            ...
            <ul className="flex flex-wrap gap-x-6 gap-y-2" aria-label="Key benefits">
              {['No centre poles', 'Engineered foundation', 'Multi-bay capable'].map((item) => (
      ...
      <section className="py-16 md:py-24 bg-white" aria-labelledby="intro-heading">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              <p className="text-[11px] font-bold tracking-[0.35em] uppercase mb-3" style={{ color: GOLD_DARK }}>Why Go Cantilever</p>
              <h2 id="intro-heading" className="text-3xl md:text-4xl font-black leading-tight mb-5" style={{ color: INK }}>
                Built For Spaces Where Poles Get In The Way
              </h2>
              <div className="w-12 h-0.5 mb-6" style={{ background: GOLD }} />
              <p className="text-[#1a1a1a]/70 text-base md:text-lg leading-relaxed mb-5">
                A standard shadeport works well in an open yard, but a tight driveway,
                a showroom floor or a dealership forecourt needs the parking area
                completely clear. A cantilever shadeport solves that by moving the
                entire support structure to one side.
              </p>
              <p className="text-[#1a1a1a]/70 text-base md:text-lg leading-relaxed">
                It costs more than a post-supported build because the foundation and
                frame need proper engineering to carry the load safely, but the payoff
                is a cleaner, more premium result that also happens to be easier to
                park under.
              </p>
              <div className="mt-6 relative aspect-[4/3] rounded-xl overflow-hidden">
                <Image
                  src="/images/cantilever-shade-port.jpg"
                  alt="Close-up of a cantilever shadeport frame and anchor point"
                  fill
      ...
      <section className="py-16 md:py-24" style={{ background: '#f5f4f0' }} aria-labelledby="types-heading">
        <div className="max-w-6xl mx-auto px-6">
          <div className="max-w-2xl mb-12">
            <p className="text-[11px] font-bold tracking-[0.35em] uppercase mb-3" style={{ color: GOLD_DARK }}>Where It Works Best</p>
            <h2 id="types-heading" className="text-3xl md:text-4xl font-black leading-tight" style={{ color: INK }}>
              Cantilever Shadeports For Every Property
            </h2>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="max-w-2xl mb-12">
            ...
            <h2 id="process-heading" className="text-3xl md:text-4xl font-black text-white leading-tight">
              From First Call To Finished Structure
            </h2>
          </div>
      ...
      {/* MID-PAGE CTA */}
      <section className="py-14 md:py-16 bg-white" aria-label="Request a free cantilever shadeport quote">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 p-8 md:p-10 rounded-2xl" style={{ background: `linear-gradient(135deg, ${RED_LIGHT}, ${RED})` }}>
            <div>
              ...
              <p className="text-white font-black text-2xl md:text-3xl leading-snug max-w-xl">
                Get a free, no-obligation quote on your cantilever shadeport today.
              </p>
            </div>
            <a
              href={`tel:${PHONE_TEL}`}
      ...
      <section className="py-16 md:py-20 bg-white" aria-labelledby="areas-heading">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <h2 id="areas-heading" className="text-2xl md:text-3xl font-black leading-tight mb-8 max-w-xl" style={{ color: INK }}>
            Cantilever Shadeports Across Gauteng &amp; Limpopo
          </h2>
      ...
      {/* FINAL CTA */}
      <section style={{ background: BG }} className="text-white" aria-label="Contact AJT Enterprise about cantilever shadeports">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            <div className="max-w-xl">
              ...
              <p className="text-white/55 text-base md:text-lg leading-relaxed">
                ...
                cantilever installation across Gauteng and Limpopo, from one dependable team.
              </p>
            </div>

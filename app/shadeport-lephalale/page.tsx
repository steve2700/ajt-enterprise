...
const AREA_NAME = 'Lephalale'
const AREA_SLUG = 'lephalale'
...
// Lephalale-specific suburbs for local relevance
const SUBURBS = [
  'Onverwacht', 'Marapong', 'Paarl', 'Restant', 'Zeeland',
  'Altona', 'Grootstryd', 'Eenzaamheid',
]

export const metadata: Metadata = {
  title: 'Shadeport & Carport Installation Lephalale | AJT Enterprise',
  description:
    "Lephalale's trusted shadeport and carport specialists. New installations, repairs and maintenance for homes and businesses across Lephalale and surrounding suburbs. Free written quote, call 065 867 7363.",
  keywords: [
    'shadeport installation Lephalale',
    'carports Lephalale',
    'shadeport repairs Lephalale',
    'carport installation Lephalale',
    'cantilever shadeports Lephalale',
    'shadeport prices Lephalale',
    'parking bay shadeports Lephalale',
    'shadeport maintenance Lephalale',
    'shadeports Onverwacht',
    'shadeports Marapong',
  ],
  ...
  openGraph: {
    ...
    title: 'Shadeport & Carport Installation Lephalale | AJT Enterprise',
    description:
      "Lephalale's trusted shadeport and carport specialists. New installations, repairs and maintenance. Free written quote, call 065 867 7363.",
    images: [{ url: '/images/shadeport-quote.png', width: 1200, height: 900, alt: 'Shadeport installation in Lephalale by AJT Enterprise', type: 'image/png' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Shadeport & Carport Installation Lephalale | AJT Enterprise',
    description: "Lephalale's trusted shadeport and carport specialists. Call 065 867 7363.",
    images: ['/images/shadeport-quote.png'],
  },
  robots: {
...
const faqs = [
  ...
  {
    question: 'What areas near Lephalale do you also cover?',
    answer: 'Alongside Lephalale, we install and maintain shadeports and carports across Polokwane, Tzaneen, Mokopane, Thohoyandou and Bela-Bela in Limpopo, and across Gauteng including Johannesburg, Pretoria and Sandton.',
  },
]
...
export default function LephalaleAreaPage() {
  return (
    <>
